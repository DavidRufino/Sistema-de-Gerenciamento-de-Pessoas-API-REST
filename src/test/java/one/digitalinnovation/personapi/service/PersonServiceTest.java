...
public class PersonServiceTest {
    ...
    //private static final String PEOPLE_API_URL_PATH = "http://localhost:8080/api/v1/people";
    ...
    void testWhenPOSTIsCalledThenAPersonShouldBeCreated() throws Exception {
        ...
        MessageResponseDTO expectedResponseMessage = createdExpectedMessageResponse("Created Person with ID: ", 1L);
    ...
    void testWhenPUTIsCalledThenAPersonShouldBeUpdated() throws Exception {
        var expectedValidId = 1L;
        PersonDTO expectedPersonDTO = createFakeDTO();
        MessageResponseDTO expectedResponseMessage = createdExpectedMessageResponse("Updated Person with ID: ", 1L);
